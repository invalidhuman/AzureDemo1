...
subscription_key = '5fE4QfoFaHY90df0EYVQP9oE9sdN0pM60KPChDkvJXHarClcEIwtJQQJ99AJACNns7RXJ3w3AAAYACOG9H6D'
region = 'koreacentral'
language = "en-US"
...
def gettonguetwister():
    tonguetwisters = [
    "Today, we expect mostly sunny skies with occasional clouds. The temperature will reach a high of 27 degrees Celsius in the afternoon, dropping to 18 degrees in the evening. Tomorrow, there will be a slight chance of rain, so don’t forget your umbrella if you’re heading out.",

    "Attention, all passengers on Flight 1025 to New York. Boarding will begin shortly at Gate 23. Please have your boarding pass and identification ready. We ask that all passengers proceed to the gate promptly. Thank you for flying with us.",

    "The library will be closed next Friday for maintenance. During this time, you can still access digital resources online. Please return any books due by Thursday. We appreciate your understanding as we work to improve our facilities.",

    "Drinking enough water is essential for your health. Experts recommend drinking at least eight glasses a day. Staying hydrated helps you stay focused, improves your mood, and keeps your body functioning well.",

    "Welcome to our hotel! Please present a valid ID and your reservation number at the front desk. Check-in is available from 3 PM, and check-out is by 11 AM. We hope you enjoy your stay and have a pleasant experience with us.",

    "You’re invited to our annual spring festival this Saturday. There will be live music, food stalls, and games for all ages. The event starts at noon in the town square, and admission is free. Don’t miss this fun day with family and friends!",

    "For your safety, please keep your seatbelt fastened while seated. In case of emergency, follow the illuminated signs to the nearest exit. We are committed to providing a safe and comfortable journey for all passengers.",

    "Our new exhibition, ‘Art Through the Ages,’ is now open. Explore over 50 pieces from various historical periods, each showcasing unique styles and stories. The exhibition will be open until the end of the month. Tickets are available at the front desk.",

    "Keeping your pet active and healthy is important. Take your dog for daily walks and provide toys to stimulate their mind. Regular vet visits and proper nutrition are key to a long, happy life for your pet.",

    "Due to scheduled maintenance, the subway line 3 will be closed this weekend. Please use alternative routes or take bus lines 10 and 11 to reach your destination. We apologize for any inconvenience and thank you for your patience."
]
